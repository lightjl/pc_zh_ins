...
class Instapaper:
    ...
    def _query(self, url=None, params=""):
        ...
        headerdata = urllib.parse.urlencode(params)
        try:
...
'''
myIns = Instapaper(userName, password)
urlHead = 'https://www.zhihu.com'
myIns.add_item('http://blog.csdn.net/shanzhizi/article/details/50903748', title='Python-第三方库requests详解', selection='股票233')
'''
